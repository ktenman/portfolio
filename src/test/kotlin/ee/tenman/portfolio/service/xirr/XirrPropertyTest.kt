...
private fun normalInvestmentGenerator() =
  Arb.bind(
...
private fun validCashFlowGenerator() =
  Arb.bind(
...
private fun generateSortedDates(
  count: Int,
  maxDayRange: Int = 365,
): List<LocalDate> {
...
private fun hasValidCashFlow(amounts: List<Double>): Boolean = amounts.any { it > 0 } && amounts.any { it < 0 }
