...
class InvestmentMetricsServiceTest {
  ...
  fun `should calculateNetQuantity with only buy transactions`() {
    val transactions =
      listOf(
        createBuyCashFlow(quantity = BigDecimal("10"), price = BigDecimal("100")),
        createBuyCashFlow(quantity = BigDecimal("15"), price = BigDecimal("110")),
      )
  ...
  fun `should calculateNetQuantity with only sell transactions`() {
    val transactions =
      listOf(
        createSellCashFlow(quantity = BigDecimal("5"), price = BigDecimal("120")),
        createSellCashFlow(quantity = BigDecimal("3"), price = BigDecimal("125")),
      )
  ...
  fun `should calculateNetQuantity with mixed buy and sell transactions`() {
    val transactions =
      listOf(
        createBuyCashFlow(quantity = BigDecimal("100"), price = BigDecimal("50")),
        createSellCashFlow(quantity = BigDecimal("30"), price = BigDecimal("60")),
        createBuyCashFlow(quantity = BigDecimal("20"), price = BigDecimal("55")),
        createSellCashFlow(quantity = BigDecimal("40"), price = BigDecimal("65")),
      )
