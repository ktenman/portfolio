...
class MarketPhaseDetectionServiceTest {
  ...
  private val service = MarketPhaseDetectionService(easterHolidayService, Clock.fixed(Instant.EPOCH, nyZone))
  ...
  fun `isWeekendPhase should return true on Saturday`() {
    ...
    val serviceWithSaturday = MarketPhaseDetectionService(easterHolidayService, Clock.fixed(saturday, nyZone))
  ...
  fun `isWeekendPhase should return true on Xetra holiday`() {
    ...
    val serviceWithHoliday = MarketPhaseDetectionService(easterHolidayService, Clock.fixed(christmasDay, nyZone))
  ...
  fun `isWeekendPhase should return false on weekday`() {
    ...
    val serviceWithWeekday = MarketPhaseDetectionService(easterHolidayService, Clock.fixed(weekday, nyZone))
