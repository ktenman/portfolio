...
enum class AiModel(
  ...
  GPT_5_6_LUNA("openai/gpt-5.6-luna", 240, sectorFallbackTier = 0, countryFallbackTier = 0),
  CLAUDE_OPUS_5("anthropic/claude-opus-5", 240, sectorFallbackTier = 1, countryFallbackTier = 1),
