...
enum class AiModel(
  ...
  GEMINI_3_5_FLASH_LITE("google/gemini-3.5-flash-lite", 400, sectorFallbackTier = 1, countryFallbackTier = 2),
  ...
  CLAUDE_OPUS_5("anthropic/claude-opus-5", 240, sectorFallbackTier = 5, countryFallbackTier = 5),
