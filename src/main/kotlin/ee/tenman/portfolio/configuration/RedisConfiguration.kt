...
class RedisConfiguration {
  ...
  companion object {
    const val INSTRUMENT_CACHE = "instrument-cache-v13"
    const val SUMMARY_CACHE = "summary-cache-v13"
    const val SUMMARY_CACHE_15 = "summary-cache-15-v13"
    const val TRANSACTION_CACHE = "transaction-cache-v13"
    const val ONE_DAY_CACHE: String = "one-day-cache-v13"
    const val THIRTY_MINUTES: String = "thirty-minutes-cache-v13"
