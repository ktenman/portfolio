...
class RedisConfiguration {
  ...
  fun cacheManager(connectionFactory: RedisConnectionFactory): RedisCacheManager {
    ...
    cacheConfigurations[DAILY_PRICE_CACHE] = RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofHours(1))
  ...
  companion object {
    ...
    const val DAILY_PRICE_CACHE: String = "daily-price"
