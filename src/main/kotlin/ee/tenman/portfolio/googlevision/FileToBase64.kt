...
object FileToBase64 {
  ...
  fun encodeToBase64(fileContent: ByteArray): String =
    BASE64_ENCODER.encodeToString(fileContent)

  fun decode(base64EncodedKey: String): ByteArray =
    BASE64_DECODER.decode(base64EncodedKey)
}
