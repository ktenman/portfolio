...
VALUES
    ((SELECT id FROM instrument WHERE symbol = 'ESIF:GER:EUR'), 'SELL', 361.818343563, 5403.39 / 361.818343563, '2026-04-15', 'LIGHTYEAR', 0),
    ...
    ((SELECT id FROM instrument WHERE symbol = 'EXA1:AEX:EUR'), 'BUY', 384.547009528, 6699.58 / 384.547009528, '2026-04-15', 'LIGHTYEAR', 0),
    ...
    ((SELECT id FROM instrument WHERE symbol = 'WEBN:GER:EUR'), 'BUY', 0.930814354, 10.79 / 0.930814354, '2026-04-15', 'LIGHTYEAR', 0);
