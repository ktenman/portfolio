...
describe('DataTable', () => {
  ...
  describe('slots', () => {
    it('should render actions slot', () => {
      ...
      expect(wrapper.findAll('.desktop-table-wrapper .btn-edit')).toHaveLength(3)
      expect(wrapper.findAll('.mobile-cards-wrapper .btn-edit')).toHaveLength(3)
    })
    ...
    it('should render custom cell slot', () => {
      ...
      const desktopCustomCells = wrapper.findAll('.desktop-table-wrapper .custom-name')
      const mobileCustomCells = wrapper.findAll('.mobile-cards-wrapper .custom-name')
