<template>
  <div class="mx-auto mt-4 w-full max-w-app px-3">
    ...
    <div v-if="transactions?.length" class="stats-container mb-6">
      <div class="stat-card">
        <div class="stat-label">Total Realized Profit</div>
        <div class="stat-value" :class="realizedProfitSum >= 0 ? 'text-gain!' : 'text-loss!'">
          {{ formatCurrency(realizedProfitSum) }}
        </div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Total Unrealized Profit</div>
        <div class="stat-value" :class="unrealizedProfitSum >= 0 ? 'text-gain!' : 'text-loss!'">
          {{ formatCurrency(unrealizedProfitSum) }}
        </div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Total Profit</div>
        <div class="stat-value" :class="totalProfitSum >= 0 ? 'text-gain!' : 'text-loss!'">
